...
namespace Ams2ChEd.Business.AMS2.Localization
{
    ...
    /// strings that need a resx key but aren't natural static-property call sites. Prefer
    /// <see cref="Strings"/>'s static properties directly in C# where the key is known at compile
    /// time - this class exists mainly for the markup extension and for the missing-translation
    /// fallback behavior described below. Mirrors AMS2ChEd.Localization.Loc in the main app project.
    /// </summary>
